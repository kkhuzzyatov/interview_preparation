...
CREATE TABLE general_application_settings (
    general_application_setting_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    answer_evaluation_prompt TEXT NOT NULL,
    new_card_recency_multiplier DOUBLE PRECISION NOT NULL,
    new_card_difficulty_multiplier DOUBLE PRECISION NOT NULL,
    new_card_color VARCHAR(255) NOT NULL
);

CREATE TABLE recency_multipliers (
    recency_multiplier_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    seconds_border INT NOT NULL,
    multiplier DOUBLE PRECISION NOT NULL
);

CREATE TABLE meet_chance_multipliers (
    meet_chance_multiplier_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    meet_chance_border DOUBLE PRECISION NOT NULL,
    multiplier DOUBLE PRECISION NOT NULL
);

CREATE TABLE difficulty_multipliers (
    difficulty_multiplier_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    last_answer_score_border INT NOT NULL,
    multiplier DOUBLE PRECISION NOT NULL
);

CREATE TABLE score_color (
    score_colors_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    score INT NOT NULL,
